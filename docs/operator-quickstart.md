# Operator Quickstart — Repair of other personal and household goods

Shortest path from clone to a verified local dry-run for **ISIC 9529** (`cloud-itonami-isic-9529`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9529.git
cd cloud-itonami-isic-9529
```
...
- Likely source path: `specialtyrepair.governor.cljc`
